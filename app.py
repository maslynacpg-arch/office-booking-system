...
# ==========================================
# TAB 2: CANCELLATION SYSTEM (ROBUST DATETIME FILTER)
# ==========================================
with tab2:
    st.subheader("Cancel an Existing Reservation")
    if not df_bookings.empty and "Status" in df_bookings.columns:
        # Convert text entries to actual operational datetimes safely
        ...
        # Filter rows chronologically based on object comparison
...
# ==========================================
# 6. LIVE REFRESHED DASHBOARD FEED (ROBUST DATETIME FILTER)
# ==========================================
st.markdown("---")
